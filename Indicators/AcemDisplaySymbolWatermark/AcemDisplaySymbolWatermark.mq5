//+------------------------------------------------------------------+
//|                                   AcemDisplaySymbolWatermark.mq5 |
//|                                             Copyright 2023, Acem |
//|                                             https://www.mql5.com |
//+------------------------------------------------------------------+
//+------------------------------------------------------------------+
...
CAcemDisplaySymbolWatermark displayWatermark;
...
{
    displayWatermark.deinit(reason);
}
...
{
//---
    displayWatermark.OnChartEvent(id, lparam, dparam, sparam);
}
//+------------------------------------------------------------------+
